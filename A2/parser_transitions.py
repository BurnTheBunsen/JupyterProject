...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if transition == "S":
            ...
            self.dependencies.append((self.stack.pop(-2), self.stack.pop(-1)))
        elif transition == "RA":
            self.dependencies.append((self.stack.pop(-1), self.stack.pop(-2)))
        else:
...
def minibatch_parse(sentences, model, batch_size):
    ...
    def is_terminated(pp: PartialParse) -> bool:
        """Checks if the given PartialParse is terminated."""
